...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TenpistaHasTransactionsException.class)
    public ProblemDetail handleTenpistaHasTransactionsException(TenpistaHasTransactionsException ex) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.CONFLICT, ex.getMessage());
        problemDetail.setTitle("Tenpista Deletion Constraint Violation");
        problemDetail.setType(java.net.URI.create(ERRORS_URI_BASE + "tenpista-has-transactions"));
        return problemDetail;
    }
